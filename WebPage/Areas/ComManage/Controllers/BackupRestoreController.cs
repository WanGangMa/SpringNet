    ...
    public class BackupRestoreController : BaseController
    {
        ...
        public ActionResult BackUpFiles()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.None, "程序备份：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "程序备份失败！";
                WriteLog(enumOperator.None, "程序备份：", e);
            }
        ...
        public ActionResult BackUpData()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.None, "数据备份：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "数据备份失败！";
                WriteLog(enumOperator.None, "数据备份：", e);
            }
        ...
        public ActionResult RestoreData()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.None, "数据还原：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "数据还原失败！";
                WriteLog(enumOperator.None, "数据还原：", e);
            }
