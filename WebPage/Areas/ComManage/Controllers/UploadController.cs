    ...
    public class UploadController : BaseController
    {
        ...
        public ActionResult DeleteBy()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.Remove, "删除文件：" + path, enumLog4net.WARN);
            }
            catch (Exception ex)
            {
                jsonM.Status = "err";
                jsonM.Msg = "删除过程中发生错误！";
                WriteLog(enumOperator.Remove, "删除文件发生错误：", ex);
            }
            return Json(jsonM);
        }
        ...
        public ActionResult CopyFiles()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.None, "复制文件：" + Request.Form["files"].Trim(';') + "，结果：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "复制文件失败！";
                WriteLog(enumOperator.None, "复制文件：", e);
            }
        ...
        public ActionResult CutFiles()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.None, "移动文件：" + Request.Form["files"].Trim(';') + "，结果：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "移动文件失败！";
                WriteLog(enumOperator.None, "移动文件：", e);
            }
        ...
        public ActionResult CompressFiles()
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.None, "压缩文件：" + Request.Form["files"].Trim(';') + "，结果：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "压缩文件失败！";
                WriteLog(enumOperator.None, "压缩文件：", e);
            }
        ...
        public ActionResult ExpandFiles()
        {
            ...
            try
            {
                ...
                string CurrentPassword = ConfigurationManager.AppSettings["ZipPassword"] != null ? new AESCrypt().Decrypt(ConfigurationManager.AppSettings["ZipPassword"].ToString()) : "guodongbudingxizhilang";
                ...
                WriteLog(enumOperator.None, "解压文件：" + Request.Form["files"].Trim(';') + "，结果：" + json.Msg, enumLog4net.WARN);
                json.Status = "y";
            }
            catch (Exception e)
            {
                json.Msg = "解压文件失败！";
                WriteLog(enumOperator.None, "解压文件：", e);
            }
