...
namespace WebPage.Areas.SysManage.Controllers
{
    public class DepartmentController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                WriteLog(enumOperator.Select, "部门管理加载主页：", e);
        ...
        public ActionResult Detail(string id)
        {
            ...
            {
                WriteLog(enumOperator.Select, "部门管理加载详情页：", e);
                throw e.InnerException;
            }
        }
        ...
        public ActionResult Save(Domain.SYS_DEPARTMENT entity)
        {
            ...
            try
            {
                ...
                {
                    WriteLog(enumOperator.Add, "添加部门信息，结果：" + json.Msg, enumLog4net.INFO);
                }
            }
            catch (Exception e)
            {
                json.Msg = "保存部门信息发生内部错误！";
                WriteLog(enumOperator.None, "保存部门信息：", e);
            }
            return Json(json);
