...
namespace WebPage.Areas.SysManage.Controllers
{
    public class PostController : BaseController
    {
        ...
        public ActionResult Detail(string id)
        {
            ...
            {
                WriteLog(enumOperator.Select, "岗位管理加载详情：", e);
                throw e.InnerException;
            }
        }
        ...
        public ActionResult Save(Domain.SYS_POST entity)
        {
            ...
            try
            {
                ...
                {
                    WriteLog(enumOperator.Add, "添加岗位，结果：" + json.Msg, enumLog4net.INFO);
                }
            }
            catch (Exception e)
            {
                json.Msg = "保存岗位发生内部错误！";
                WriteLog(enumOperator.None, "保存岗位：", e);
            }
            return Json(json);
        ...
        public ActionResult Delete(string idList)
        {
            ...
            try
            {
                ...
                WriteLog(enumOperator.Remove, "删除岗位，结果：" + json.Msg, enumLog4net.WARN);
            }
            catch (Exception e)
            {
                json.Msg = "删除岗位发生内部错误！";
                WriteLog(enumOperator.Remove, "删除岗位：", e);
            }
            return Json(json);
        }
